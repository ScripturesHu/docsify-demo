...
resources文件夹下的com.hjw.mapper.UserMapper.xml
...
**以下分别介绍environments、mapper、properties、typeAliases、typeHandlers、plugins标签：**
...
int delete(String statement, Object parameter);Copy to clipboardErrorCopied
```
